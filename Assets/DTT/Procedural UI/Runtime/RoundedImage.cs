...
namespace DTT.UI.ProceduralUI
{
    ...
    public class RoundedImage : Image
    {
        ...
        /// <summary>
        /// The border component used for the rounded image.
        /// </summary>
        ...
        { 
            ...
            {
                if (_border != null)
                    _border.OnUpdate -= UpdateGeometry;
        ...
        /// <summary>
        /// This event gets invoked when the rounded image is updated.
        /// </summary>
        ...
        /// <summary>
        /// The border used as an extension of rounded image.
        /// </summary>
...
#pragma warning restore 0414
        ...
        /// <summary>
        /// Adds a listener to the update event of the border.
        /// </summary>
        ...
        /// <summary>
        /// Removes the listener from the update event of the border.
        /// </summary>
        ...
        /// <summary>
        /// Returns a collection with the rounding in percentages from every corner mapped by the corner adjusted by the border, if applicable.
        /// </summary>
        /// <returns>
        /// A collection with the rounding in percentages from every corner mapped by the corner adjusted by the border, if applicable.
        /// </returns>
        protected ReadOnlyDictionary<Corner, float> GetTrueCornerRounding()
        {
            if (_border == null || !_border.RenderOutside)
                return GetCornerRounding();

            Dictionary<Corner, float> output = new Dictionary<Corner, float>();
            for (int i = 0; i < _roundingAmount.Length; i++)
            {
                Corner c = (Corner)i;
                output.Add(c, Mathf.Max(GetCornerRounding(c) - _border.BorderThickness + GetCornerRounding(c) * _border.BorderThickness, 0));
            }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            var rounding = GetTrueCornerRounding();
